...
Сценарий: 08.05 Создание экземпляра отчета - "VA - Cumulative total (recipient)" 
	...
	* Рассчитываем и сверяем документ
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен макету "3_Budgeting\Templates\08\VA_НарастающийTotal.mxl"
	...
	* Смотрим движения
		...
		Дано Табличный документ 'ReportSpreadsheetDocument' равен макету "3_Budgeting\Templates\08\VA_НарастающийTotal_Движения.mxl" по шаблону
